    ...
    public static void main(String[] args) {
        ...
        if (inp_str.length() == 1 && inp_str.charAt(0) == '0'){
            ...
            System.out.println("""
                ...
                Введите новый шаблон для форматирования, используя следующую легенду (прерывающиеся и дублирующие группы символов не допускаются):
                d - числовой символ дня месяца
                m - числовой символ месяца
                l - текстовый символ наименования месяца
                y - числовой символ номера года
                "." / "/" / "\\" / "-" / "_" - символы-разделители\040
                Новый шаблон:\040""");
